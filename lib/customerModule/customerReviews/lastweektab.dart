...
class Lastweektab extends StatefulWidget {
  const Lastweektab({super.key});

  @override
  State<Lastweektab> createState() => _LastweektabState();
}

class _LastweektabState extends State<Lastweektab> {
                ...
                child: Consumer<AuthProvider>(
                  builder: (context, AuthProvider, _) {
                    ...
                    Future<List<Map<String, dynamic>>> videoDetailsFuture =
                        AuthProvider.lastweektabVideodetails();
